...
def main(params):
    ...
    e_opt = optim.Adam(list(model.embedder.parameters()) + list(model.recovery.parameters()), lr=0.001)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--Z_dim', type=int, default=50, help='Dimension of the random noise vector')
    parser.add_argument('--hidden_dim', type=int, default=64, help='Dimension of the hidden layers in the model')
