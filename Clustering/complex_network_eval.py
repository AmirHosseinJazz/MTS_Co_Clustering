...
def eval():
    ...
    folders_2=[
        x[0] for x in os.walk("./experiment_embedded_data") if "experiment_embedded_data" in x[0]
    ]
    folders_3=[
        x[0] for x in os.walk("./experiment_simple_clustering") if "experiment_simple_clustering" in x[0]
    ]
    # read all data
    data = []
